...
public class PrivilegeHttpContextExtensionsTests
{
    [Fact(DisplayName = "LogPrivilegePermissionsChangedFromHttp without metadata should add HttpContext values to event metadata")]
    public void LogPrivilegePermissionsChangedFromHttp_WithoutMetadata_ShouldAddHttpContextValues()
    {
        // Arrange
        ...
        // Act
        securityLogger.LogPrivilegePermissionsChangedFromHttp("Test message", null, null, null, null, httpContext);
    ...
    [Fact(DisplayName = "LogPrivilegePermissionsChangedFromHttp with metadata should not override predefined metadata values")]
    public void LogPrivilegePermissionsChangedFromHttp_WithMetadata_ShouldNotOverridePredefinedValues()
    {
        // Arrange
        ...
        // Act
        securityLogger.LogPrivilegePermissionsChangedFromHttp("Test message", null, null, null, null, httpContext, metadata);
